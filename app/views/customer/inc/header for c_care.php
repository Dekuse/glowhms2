...
<html>
  ...
  <link rel="stylesheet" href="<?php echo URLROOT ?>/public/home assests/vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.css">
  <!-- DataTables -->
 ...
 .has-success
 {
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
   ...
   <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo URLROOT; ?>/customer/regcustomer" class="logo">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo URLROOT; ?>/customer/profile" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo URLROOT; ?>/customer/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
