    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="">
                <form method="post" class="form-horizontal" id="noti_form"
                                        name="noti_form" action="" enctype=”multipart/form-data”>
                <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                                    <div class="box-header with-border">
                                        <h4 class="box-title">Notification Type</h4>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="">
                                        <select class="form-control control" name="NOTI_STATUS" id="NOTI_STATUS"
                                            title="Visa Type">

                                            <option value="">SELECT</option>
                                                            <option value="S">SEEN</option>
                                                            <option value="NS">NOT SEEN</option>
...
<script src="<?php echo URLROOT ?>/public/assets/system scripts/notifications.js"></script>
