...
<html>
  <head>
    ...
    <meta http-equiv="refresh" content="1000;url=<?php echo URLROOT; ?>/administrator/logout" >
  ...
  <link rel="stylesheet" href="<?php echo URLROOT ?>/public/assets/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  <!-- DataTables -->
  ...
  <link rel="stylesheet" href="<?php echo URLROOT ?>/public/assets/plugins/toastr/toastr.min.css">
  <!-- Theme style -->
  ...
  <link rel="stylesheet" href="<?php echo URLROOT ?>/public/assets/styles/active-status.css">
  <style>
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
   ...
   <header class="main-header">
    ...
    <a href="<?php echo URLROOT; ?>/administrator/index" class="logo">
      ...
      <span class="logo-lg"><b>GHMS</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <li class="header">You have <span class="badge bg-green" id="notification_count"></span > new notifications</li>
              <li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo URLROOT; ?>/administrator/profile" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo URLROOT; ?>/administrator/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
